<template>
	<view>
		...
		<view class="default">
			...
			<k-button type="primary" round disabled>primary</k-button>
			<k-button type="primary" plain disabled>primary</k-button>
		</view>
		<view class="default">
